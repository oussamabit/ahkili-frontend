      ...
      <div className="mb-8">
        ...
        <div className="relative">
          <select 
            ...
            className="w-full md:w-80 px-6 py-4 bg-white/80 backdrop-blur-sm border-2 border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary focus:border-primary transition-all shadow-md hover:shadow-lg appearance-none cursor-pointer font-medium text-gray-700"
          >
