...
const Login = () => {
  ...
  useEffect(() => {
    const fetchCommunities = async () => {
      try {
        ...
        // Map communities to interests format
    ...
    try {
      if (isSignUp) {
        if (signupStep === 1) {
          ...
          // Final signup with Firebase
          await signup(formData.email, formData.password, formData.username);
          
          // TODO: Save selected interests to user profile in Firestore
          // You'll need to add a function to save interests to your database
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-orange-50 py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-emerald-500 to-orange-400 p-6 text-white">
            {isSignUp ? (
              <>
                <h1 className="text-2xl font-bold mb-2">Create Account</h1>
                <p className="text-emerald-50">Step {signupStep} of 3</p>
              ...
              <>
                ...
                <p className="text-emerald-50">Sign in to continue</p>
              </>
            )}
          </div>
          ...
          <div className="p-6">
            ...
            {!isSignUp && (
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-white py-3 rounded-lg hover:from-emerald-600 hover:to-emerald-700 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                >
            ...
            {isSignUp && signupStep === 1 && (
              <div className="space-y-4">
                ...
                <button
                  ...
                  onClick={handleSubmit}
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-white py-3 rounded-lg hover:from-emerald-600 hover:to-emerald-700 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed shadow-lg flex items-center justify-center gap-2"
                >
                  {loading ? 'Loading...' : (
                    <>
                      Continue
            ...
            {isSignUp && signupStep === 2 && (
              <div className="space-y-4">
                <div className="bg-gradient-to-br from-emerald-50 to-orange-50 rounded-lg p-4 max-h-80 overflow-y-auto">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    onClick={handleSubmit}
                    disabled={loading}
                    className="flex-1 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white py-3 rounded-lg hover:from-emerald-600 hover:to-emerald-700 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed shadow-lg flex items-center justify-center gap-2"
                  >
                    {loading ? 'Loading...' : (
                      <>
                        Continue
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    onClick={handleSubmit}
                    disabled={loading}
                    className="flex-1 bg-gradient-to-r from-emerald-500 to-orange-400 text-white py-3 rounded-lg hover:from-emerald-600 hover:to-orange-500 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed shadow-lg flex items-center justify-center gap-2"
                  >
            ...
            {/* Divider - Only show on login and signup step 1 */}
            {(!isSignUp || signupStep === 1) && (
              <>
            ...
            {/* Toggle Sign Up / Login - Only show on login and signup step 1 */}
            {(!isSignUp || signupStep === 1) && (
            ...
            {/* Back to Login button for steps 2 and 3 */}
