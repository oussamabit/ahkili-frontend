          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-emerald-500 text-white py-3 rounded-lg hover:bg-emerald-600 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
              >
